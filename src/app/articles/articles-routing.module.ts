...
const routes: Routes = [
  {
    ...
    [
      ...
      { path: KochCurveComponent.route, component: KochCurveComponent },
      { path: CesaroFractalComponent.route, component: CesaroFractalComponent },
      { path: QuadraticKochIslandComponent.route, component: QuadraticKochIslandComponent },
      { path: SierpinskiArrowheadComponent.route, component: SierpinskiArrowheadComponent },
      { path: SierpinskiCurveComponent.route, component: SierpinskiCurveComponent },
      { path: MooreCurveComponent.route, component: MooreCurveComponent },
      { path: FractalCanopyComponent.route, component: FractalCanopyComponent },
      { path: BinaryFractalTreeComponent.route, component: BinaryFractalTreeComponent },
      { path: FractalPlantComponent.route, component: FractalPlantComponent },
      { path: TerdragonComponent.route, component: TerdragonComponent },
      { path: TwindragonComponent.route, component: TwindragonComponent },
      { path: PaperfoldingCurveComponent.route, component: PaperfoldingCurveComponent },
      { path: BoxFractalComponent.route, component: BoxFractalComponent },
      { path: CrossFractalComponent.route, component: CrossFractalComponent },
      { path: KochAntisnowflakeComponent.route, component: KochAntisnowflakeComponent },
      { path: PentaflakeComponent.route, component: PentaflakeComponent },
      { path: HexaflakeComponent.route, component: HexaflakeComponent },
      { path: DurerPentagonComponent.route, component: DurerPentagonComponent },
      { path: MengerSpongeComponent.route, component: MengerSpongeComponent },
      { path: JerusalemCrossComponent.route, component: JerusalemCrossComponent },
