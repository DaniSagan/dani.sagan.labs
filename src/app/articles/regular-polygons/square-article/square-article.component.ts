...
@Component({
  selector: 'app-square-article',
  standalone: true,
  imports: [],
  templateUrl: './square-article.component.html',
  styleUrl: './square-article.component.css'
})
export class SquareArticleComponent {
  @ViewChild('canvas', { static: true }) canvas!: ElementRef<HTMLCanvasElement>;
  private ctx!: CanvasRenderingContext2D;

  static title: string = 'Cuadrado';
  static route: string = 'square';
